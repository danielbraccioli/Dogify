...
<html lang="en">
  ...
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="http://localhost:8080/ClienteWeb/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  ...
  <%
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="http://localhost:8080/ClienteWeb/logochico.png" 
     srcset = "http://localhost:8080/ClienteWeb/logochico.png 2x, 
             ...
             http://localhost:8080/ClienteWeb/logochico.png 1200w 2x" /></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h1 class="mt-5">Necesitamos identificarte!</h1>
          <p class="lead">Ingresa tus datos de registro para acceder al sitio</p>
